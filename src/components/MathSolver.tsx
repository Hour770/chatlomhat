...
export default function MathSolver() {
  ...
  const { isAuthenticated, addToSolverHistory } = useAuth();
  ...
  const solveProblem = async () => {
    ...
    try {
      ...
      const solution = data.solution || "No solution received";
      setResponse({ 
        solution, 
        loading: false 
      });
      ...
      if (isAuthenticated && solution) {
        addToSolverHistory(problem || "Image problem", solution);
      }
    } catch (error) {
      setResponse({ 
        solution: "", 
